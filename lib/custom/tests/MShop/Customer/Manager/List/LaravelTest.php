...
class MShop_Customer_Manager_List_LaravelTest extends MW_Unittest_Testcase
{
	private $_object;
	private $_context;
	...
	protected function setUp()
	{
		...
		$this->_object = $manager->getSubManager( 'list', 'Laravel' );
	}
	...
	{
		$this->assertInstanceOf( 'MShop_Common_Item_List_Interface', $this->_object->createItem() );
	}
